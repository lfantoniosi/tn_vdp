...
//create_generated_clock -name clk_cpu -source [get_ports {clk_111}] -master_clock clk_111 -divide_by 31  -multiply_by 1 -add [get_nets {clk_111}]
//create_generated_clock -name clk_grom -source [get_ports {clk_111}] -master_clock clk_111 -divide_by 248 -multiply_by 1 -add [get_nets {clk_111}]
